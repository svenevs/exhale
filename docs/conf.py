...
# sphinx-quickstart on Wed Aug 10 13:27:35 2016.
#
...
import os
import shlex
sys.path.insert(0, os.path.abspath('..')) # path to exhale.py
...
project = u'exhale'
copyright = u'2016, Stephen McDowell'
...
latex_documents = [
  (master_doc, 'exhale.tex', u'exhale Documentation',
...
man_pages = [
    (master_doc, 'exhale', u'exhale Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'exhale', u'exhale Documentation',
   author, 'exhale', 'One line description of project.',
   'Miscellaneous'),
]
